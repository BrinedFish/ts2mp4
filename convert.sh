...
/home/jnakano/ffmpeg/bin/ffmpeg -y -i "ts/$TS_NAME" $PROGRAM_OPT_V -c:v libx264 -preset ultrafast -profile main -level 3.1 -s 1280x720 $PROGRAM_OPT_A -c:a libfdk_aac "mp4/$TMP_MP4_NAME"
mv "mp4/$TMP_MP4_NAME" "/home/jnakano/public_html/ipad_movies/$MP4_NAME"
